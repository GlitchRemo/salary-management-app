...
import { PayrollBarChart, BudgetAllocationChart, SalaryRangeChart, SalaryDistributionChart } from "@/components/organisms/DashboardCharts";
...
export default async function DashboardPage({
  ...
  const [summary, salaryDistribution, avgByDept, budget, salaryRange, topEarners] = await Promise.all([
    getSummaryStatsForCountry(country),
    getSalaryDistributionByDepartment(country),
